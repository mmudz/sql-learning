...
-- 08. Show the countries that are big by area (more than 3 million) or big by population (more than 250 million) but not both. Show name, population and area.
...
-- 09. For Americas show population in millions and GDP in billions both to 2 decimal places.
